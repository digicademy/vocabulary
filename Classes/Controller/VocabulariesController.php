 ...
 */
class VocabulariesController extends ActionController
{

    /**
     * vocabulariesRepository
     *
     * @var \Digicademy\Vocabulary\Domain\Repository\VocabulariesRepository
     * @inject
     */
    protected $vocabulariesRepository = null;
    ...
    public function showSelectedVocabularyAction()
    {
        if ((int)$selectedVocabulary = $this->settings['general']['selectedVocabulary']) {
            $this->view->assign(
                'selectedVocabulary',
                $this->vocabulariesRepository->findByUid($selectedVocabulary)
            );
        }
