<?php
namespace Digicademy\Vocabulary\Service;
...
// the resolver service resolves URIs (of resources) to URLs (document representations)
// each resolver gets a representation type (by scheme: t3, http, https, ftp etc.)
...
class ResolverService
{
    ...
    {
        $this->availableResolvers = $GLOBALS['TYPO3_CONF_VARS']['EXTCONF']['vocabulary']['resolver'];
//@TODO: implement hook for resolvers from extensions
     ...
     * @return string
     */
     public function resolve(Representations $representation, $settings)
     {
        $url = '';
